...
import { PREVIEW_MESSAGES } from '../constants/mockData';
        ...
        <div className="grid grid-cols-4 sm:grid-cols-6 md:grid-cols-8 gap-1">
          {THEMES.map((t) => (
            <button
              key={t}
              onClick={() => setTheme(t)}
              className={`flex flex-col items-center gap-2 p-2 rounded-xl transition-colors hover:bg-accent/10 ${
                theme === t ? 'bg-accent/20' : ''
              }`}
            >
              <div
